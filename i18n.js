...
(function () {
  var DICT = {
    en: {
      ...
      "contact.intro": "If you\u2019re working on something in space policy, security, or sustainability, I\u2019d like to hear about it. Whether it's a role, a project, or just a good conversation, the fastest ways to reach me are right here.",
      ...
      "pr.title": "Things I'm building", "pr.dek": "Work I've designed and built, laid out on a timeline. Pick any one to read the full case.", "pr.readmore": "Read more", "pr.featured": "Featured project", "pr.status.in-progress": "In progress", "pr.status.shipped": "Shipped", "pr.status.concept": "Concept",
    ...
    de: {
      ...
      "pr.title": "Woran ich arbeite", "pr.dek": "Arbeiten, die ich entworfen und gebaut habe, auf einer Zeitleiste. W\u00e4hle eine aus, um den vollst\u00e4ndigen Fall zu lesen.", "pr.readmore": "Mehr lesen", "pr.featured": "Ausgew\u00e4hltes Projekt", "pr.status.in-progress": "Laufend", "pr.status.shipped": "Ver\u00f6ffentlicht", "pr.status.concept": "Konzept",
    ...
    fr: {
      ...
      "home.quote": "\u00ab\u00a0Je veux rendre l'espace plus accessible, permettre \u00e0 celles et ceux qui <em>peuvent</em> agir dans l'espace de <em>pouvoir</em> le faire.\u00a0\u00bb", "facts.degree.l": "Dipl\u00f4me", "facts.degree.v": "M.S. Space Studies, ISU (2026)", "facts.based.l": "Bas\u00e9 \u00e0", "facts.based.v": "Stuttgart, Allemagne", "facts.status.l": "Statut", "facts.status.v": "Citoyen am\u00e9ricain, mobile", "facts.avail.l": "Disponible", "facts.avail.v": "Imm\u00e9diatement", "skip": "Aller au contenu",
      ...
      "pr.title": "Ce que je construis", "pr.dek": "Des travaux que j'ai con\u00e7us et construits, pr\u00e9sent\u00e9s sur une frise chronologique. Choisissez-en un pour lire le dossier complet.", "pr.readmore": "En savoir plus", "pr.featured": "Projet phare", "pr.status.in-progress": "En cours", "pr.status.shipped": "Livr\u00e9", "pr.status.concept": "Concept",
    ...
    es: {
      ...
      "home.quote": "\u00abQuiero hacer el espacio m\u00e1s accesible, permitir que quienes <em>pueden</em> actuar en el espacio <em>puedan</em> hacerlo.\u00bb", "facts.degree.l": "Titulaci\u00f3n", "facts.degree.v": "M.S. Space Studies, ISU (2026)", "facts.based.l": "Ubicaci\u00f3n", "facts.based.v": "Stuttgart, Alemania", "facts.status.l": "Situaci\u00f3n", "facts.status.v": "Ciudadano estadounidense, dispuesto a mudarse", "facts.avail.l": "Disponible", "facts.avail.v": "De inmediato", "skip": "Ir al contenido",
      ...
      "pr.title": "En lo que estoy trabajando", "pr.dek": "Trabajos que he dise\u00f1ado y construido, presentados en una l\u00ednea de tiempo. Elige cualquiera para leer el caso completo.", "pr.readmore": "Leer m\u00e1s", "pr.featured": "Proyecto destacado", "pr.status.in-progress": "En curso", "pr.status.shipped": "Publicado", "pr.status.concept": "Concepto",
